...
# Plotar os dados das classes (classe 1 - psoríase, classe 2 - dermatite seborréica, classe 3 - líquen plano, classe 4 - pitiríase rósea, classe 5 - dermatite crônica e classe 6 - pitríase rubra pilar)
#plot(dados$X2.1, dados$X0.7, pch=21,
     #bg=c('blue','green','red','black','gray','yellow')[as.numeric(dados$X2.3)],
     #xlab = 'X2.1', ylab = 'X0.7')
#title('Conjunto de Dados Dermatology')
...
write.csv(matriz_confusao, 'Matriz_Confusao_MLP_Dermatology.txt',row.names = TRUE)
